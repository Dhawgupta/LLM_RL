...
from llm_rl_scripts.wordle.scripted_policies import UserPolicy
...
if __name__ == "__main__":
    N_INTERACTIONS = 20
    OUTPUTS_PATH = "gcs://charlie-bucket2/LLM_RL_outputs/wordle/gpt4_eval/user_interactions_test1_temp/"
