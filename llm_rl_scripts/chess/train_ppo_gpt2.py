...
from llm_rl_scripts.chess.data import chess_text_transition_from_json, get_data_from_bucket
...
def main(
    ...
    def ppo_dataset_loader():
        ...
        text_trajectory_chains = list(chess_text_transition_from_json(data))
