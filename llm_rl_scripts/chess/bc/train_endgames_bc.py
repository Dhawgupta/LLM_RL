...
from llm_rl_scripts.chess.env import preprocess_move, preprocess_state, text_env_eval_chess_positions
...
def main(
    ...
    path_to_test = "gcs://rl-llm-bench-dataset/chess/queen_rook_unopposed/tricky_test_positions.jsonl"
