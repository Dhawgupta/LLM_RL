...
def main(
    ...
    train_data_path = "gcs://rl-llm-bench-dataset/chess/eps_greedy_3mill/full_games.jsonl"
        ...
        with open(data_path, "r") as f:
            for obj in f:
                ...
                if (filtered and result[-1]["reward"] == 1) or not filtered:
                    for item in result:
                        yield {"in_text": preprocess_state(item["from_state"]), "out_text": preprocess_move(item["action"])}
