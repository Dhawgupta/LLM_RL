...
# raw_scores = [-72.1, -56.4, -48.1, -6.97, -37.7]
# raw_scores_po = [-79.5, -82.9, -80.3, -52.9, -91.7]
# for score in raw_scores_po:
...
# chess_scores = [-22.3, -56.5, -28.2, -21.4, -16.0]
...
endgames_scores = [0.112, -0.439, 0.588, 0.452, 0.814]
...
po_scores = [-79.5, -82.9, -80.3, -52.9, -91.7]
