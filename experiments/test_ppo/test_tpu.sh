...
# python -m examples_jaxseq.gptj.gptj_train \
#     CONFIG \
#     experiments/test_ppo/base_config.json \
#     gcs://rail-tpus-csnell-us/test_ppo/10bit_data_multichain.jsonl \
#     gcs://rail-tpus-csnell-us/test_ppo/10bit_data_multichain.jsonl \
#     --epochs 1 \
#     --train_bsize 64 \
#     --eval-loss-bsize 64 \
...
#     --use-wandb \
#     --wandb-project "ppo_test_multichain_initial_finetune" \
#     --model-mesh-shape 1 \
#     --data-mesh-shape 4 \
