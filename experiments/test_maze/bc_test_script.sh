...
python -m llm_rl_scripts.maze.bc.partially_observed_bc \
    HF \
    gpt2 \
    gcs://rl-llm-bench-dataset/maze/double_t_maze/double_t_maze_submazes_filtered_dialogue_history.jsonl \
    0.90 \
    --exp-name maze_partial_observation_filtered_test3 \
...
#     HF \
#     gpt2 \
#     gcs://rl-llm-bench-dataset/maze/double_t_maze/double_t_maze_submazes_dialogue_history.jsonl \
#     0.90 \
#     --exp-name maze_partial_observation_test3 \
#     --outputs-path gcs://rail-tpus-csnell-us/LLM_RL_outputs/maze/ \
#     --data-mesh-shape 1 \
#     --fsdp-mesh-shape -1 \
#     --model-mesh-shape 1 \
...
#     0.90 \
#     --exp-name maze_partial_observation_test2 \
#     --outputs-path gcs://rail-tpus-csnell-us/LLM_RL_outputs/maze/ \
#     --data-mesh-shape 1 \
#     --fsdp-mesh-shape -1 \
#     --model-mesh-shape 1 \
